          ...
          <div class="col-12 shadow-2 cb-round-borders-10 q-mb-xs">
            <q-item class="q-px-sm q-py-none" style="min-height: 30px">
              <q-item-section style="max-width: 30px">
                <q-icon class="text-grey-5" name="home" size="sm" />
              </q-item-section>
              <q-item-section>
                <q-input borderless placeholder="Flat,Floor,Building Name" v-model="building_floor" class="bg-white cb-round-borders-10" dense ></q-input>
              </q-item-section>
            </q-item>
          </div>
...
export default {
  ...
  methods: {
    ...
    getReverseGeocodingData() {
      var ps = this;
      var myArray = ps.$route.query.searched_latlong.split(",");
      ...
      geocoder.geocode({ latLng: latlng }, (results, status) => {
        ...
        if (status == google.maps.GeocoderStatus.OK) {
          ...
          this.$store.dispatch("searched_adderss_data", {
              pincode: pincode,
